...
> **Guide to creating and using Skills in this project**

---

## 📋 Overview

Claude Code is a powerful generalist, but it doesn't automatically know your specific project context or your team's standards. Loading every rule into the model's context window leads to "tool bloat," higher costs, latency, and confusion.

**Skills** solve this through **progressive disclosure**. A Skill is a package of specialized knowledge that remains dormant until needed. The skill content is only loaded into the model's context when the request matches the skill's description, via the `Skill` tool.
