...
description: Use this agent when exploring legacy or undocumented code, mapping unfamiliar modules, planning safe refactors of tangled systems, recovering intent from old commits, or doing modernization planning. Triggers on legacy, refactor, archaeology, undocumented, spaghetti code, untangle, rewrite, analyze repo, explain codebase.
