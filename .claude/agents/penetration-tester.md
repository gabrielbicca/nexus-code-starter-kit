...
description: Use this agent when actively probing for exploits in an authorized environment, attempting authorization bypass, testing for injection or SSRF, simulating attacks, or doing offensive security assessments. Authorized testing only — distinct from security-auditor (which reviews code defensively). Triggers on pentest, exploit, attack simulation, breach, redteam, offensive security, vulnerability assessment.
