...
description: Use this agent when building UI components, pages, forms, layouts, dashboards, or styling with Next.js, React, Tailwind, or shadcn/ui. Also for client-side state management, accessibility, and responsive design. Triggers on frontend, UI, component, page, form, layout, react, next, tailwind, shadcn, styling, responsive, accessibility.
