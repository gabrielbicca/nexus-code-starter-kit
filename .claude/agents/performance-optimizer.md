...
description: Use this agent when investigating slow queries, large bundles, sluggish renders, poor Core Web Vitals, memory leaks, unexpected latency, or doing performance profiling. Triggers on slow, performance, optimize, latency, bundle size, web vitals, memory leak, profiling, lighthouse, benchmark.
