---
name: game-developer
description: Use this agent when implementing game mechanics, physics, game loops, scoring systems, level design, sprite/animation logic, multiplayer netcode, or 2D/3D graphics with engines like Unity, Godot, Unreal, Phaser, or Three.js. Triggers on game, gameplay, physics, mechanics, sprite, level, score, gamedev, unity, godot, unreal, phaser, three.js.
