...
description: Use this agent when designing database schemas, writing Postgres/Supabase migrations, optimizing queries, designing indexes, modeling relationships, or writing RLS policies. Triggers on database, sql, schema, migration, query, postgres, supabase, RLS, index, table, relationship, EXPLAIN.
