...
description: Use this agent when building iOS or Android apps with React Native, Expo, Flutter, Swift, or Kotlin — including native modules, mobile-specific UI patterns, app store deployment, push notifications, or platform integrations. Triggers on mobile, ios, android, react native, expo, flutter, swift, kotlin, app store, push notification.
