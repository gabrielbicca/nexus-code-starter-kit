---
name: explorer-agent
description: Use this agent for broad codebase exploration when you need to map unfamiliar territory, find where a feature is implemented, answer "where is X?" questions across many files, or do initial architectural audits. Triggers on explore, find, where, locate, map, search, codebase, audit, discover.
