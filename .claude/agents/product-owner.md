---
name: product-owner
description: Use this agent when defining MVP scope, doing backlog grooming, making strategic product trade-offs between scope/time/quality, facilitating requirements elicitation, or bridging business and technical execution. Triggers on MVP, backlog, scope, trade-off, sprint planning, grooming, stakeholder, business value.
