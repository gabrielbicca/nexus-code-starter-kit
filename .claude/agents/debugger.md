---
name: debugger
description: Use this agent when investigating runtime errors, race conditions, unexpected behavior, intermittent failures, production incidents, or doing root-cause analysis on bugs. Triggers on bug, error, crash, broken, failing, regression, root cause, stacktrace, debug, investigate, not working.
