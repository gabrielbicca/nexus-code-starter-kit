...
description: Use this agent when configuring CI/CD pipelines, Docker, Coolify deployments, environment variables, GitHub Actions, infrastructure-as-code, server management, or production rollback operations. HIGH RISK — affects production. Triggers on deploy, production, CI, CD, docker, pipeline, infrastructure, env vars, coolify, github actions, rollback, release, ssh.
