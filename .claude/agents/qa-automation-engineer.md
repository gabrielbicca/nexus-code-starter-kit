...
description: Use this agent when writing E2E tests with Playwright or Cypress, setting up automated regression suites, designing CI test pipelines, or covering critical user flows with browser automation. Triggers on E2E, end-to-end, playwright, cypress, automation, regression, smoke test, browser test, CI pipeline.
