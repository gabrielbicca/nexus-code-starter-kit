---
name: seo-specialist
description: Use this agent when optimizing meta tags, structured data, sitemap, robots.txt, page performance for search ranking, doing keyword/content research, or improving E-E-A-T and AI search visibility (GEO). Triggers on SEO, meta tags, structured data, sitemap, ranking, keywords, search engine, schema.org, GEO, AI citation.
