...
description: Use this agent when translating user research into product features, writing PRDs, user stories, acceptance criteria, prioritizing roadmap items, or aligning stakeholders on requirements. Triggers on PRD, requirements, roadmap, user story, feature spec, prioritization, stakeholder alignment.
